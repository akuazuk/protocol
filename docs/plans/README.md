...
| Файл | Тема | Статус |
|------|------|--------|
| [2026-08-09-mo-score-ssot-llm-recompute-v3.md](2026-08-09-mo-score-ssot-llm-recompute-v3.md) | C0-C5 выполнены: frozen Arm D, 30×2 blind GCE pilot, 22 adjudications; C6 methodist labels следующий | active |
