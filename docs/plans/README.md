| Файл | Тема | Статус |
|------|------|--------|
| [2026-08-10-mo-eval-quality-followups-v2.md](2026-08-10-mo-eval-quality-followups-v2.md) | После 3600047: fix meloxicam→diclofenac, справка потолков, deep-rescore; без ложных ручек таксономии | active |
