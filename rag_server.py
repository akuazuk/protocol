...
- Для акцентов на критичных моментах начинай отдельные абзацы или пункты списка с «ВАЖНО:» или «Внимание:» (одна строка, без markdown).
...
- Для ключевых предупреждений используй строки, начинающиеся с «ВАЖНО:» или «Внимание:».
