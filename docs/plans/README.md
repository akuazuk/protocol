...
| [2026-08-08-mo-analytics-implementation-blueprint-v1.md](2026-08-08-mo-analytics-implementation-blueprint-v1.md) | Пошаговый blueprint UI/API/склада: дашборды, таблицы, графики, разбор случая | active |
...
| [2026-07-30-mo-analytics-bi-redesign-v1.md](2026-07-30-mo-analytics-bi-redesign-v1.md) | МО Аналитика: редизайн BI (ECharts, фильтры, «Вчера» и «Месяц»), доставка данных в прод и оценка v4 | active (продуктовый канон дашборда → [three-layer-redesign-v1](2026-08-08-mo-analytics-three-layer-redesign-v1.md)) |
