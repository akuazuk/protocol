...
Дата: 2026-08-08  
Статус: archived  
Преемник: `2026-08-08-mo-patient-history-bundle-v2.md` (сначала история **пациента** у врача и специальности; привычность кода - часть анализа поверх бандла).  
Связано: `2026-08-08-mo-icd-name-match-v2.md`, `mo_backend._doctor_breakdown`, `mo_case_document.load_prior_clinical`.  
Источник (исходный черновик): учитывать, встречался ли ID диагноза у врача/специальности. **Устарело как фундамент** - см. v2.
