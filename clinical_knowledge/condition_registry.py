...
def _defs() -> list[ConditionDef]:
    g = [
        ...
        ("abdominal_trauma", ("травм", "живот"), ("S36",), ("травм", "живот"), ("травм",)),
        ("acute_bronchitis", ("бронхит", "кашель"), ("J20", "J21"), ("бронхит",), ("бронхит",)),
        ...
        ("thyroid_disease", ("щитовид", "гипотиреоз", "гипертиреоз"), ("E03", "E04", "E05", "E06"), ("щитовид",), ("щитовид",)),
