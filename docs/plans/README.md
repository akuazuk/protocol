...
| Файл | Тема | Статус |
|------|------|--------|
| [2026-08-09-mo-dashboards-zones-first-v1.md](2026-08-09-mo-dashboards-zones-first-v1.md) | Дашборды МО: зоны primary + review/gaps/МКБ; №55 section secondary; замена старого BI с учётом PR #87 | active |
...
| [2026-07-30-mo-analytics-bi-redesign-v1.md](2026-07-30-mo-analytics-bi-redesign-v1.md) | МО Аналитика: редизайн BI (ECharts, фильтры, «Вчера» и «Месяц»), доставка данных в прод и оценка v4 | active (замена hero-дашбордов → [mo-dashboards-zones-first-v1](2026-08-09-mo-dashboards-zones-first-v1.md)) |
