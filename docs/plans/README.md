| Файл | Тема | Статус |
|------|------|--------|
| [2026-08-14-mo-kp-suggest-accuracy-v1.md](2026-08-14-mo-kp-suggest-accuracy-v1.md) | Точность подбора КП: прогон июля после #149, омнибус/пусто/возраст | active |
