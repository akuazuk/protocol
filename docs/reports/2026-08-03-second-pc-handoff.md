...
> Статус: superseded. Актуальное состояние после PR #1-#3 и новые multi-agent
> правила зафиксированы в `docs/reports/2026-08-03-handoff-mo-analytics-multi-agent.md`
> и корневом `AGENTS.md`.
