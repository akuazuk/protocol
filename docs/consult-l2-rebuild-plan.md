...
- [lazy-chunk-store-pr-plan.md](./lazy-chunk-store-pr-plan.md) — lazy chunks для evidence
- [kz_compliance_implementation_plan.md](./kz_compliance_implementation_plan.md) — alignment / structured
