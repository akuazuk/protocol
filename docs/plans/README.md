...
| Файл | Тема | Статус |
|------|------|--------|
| [2026-08-05-mo-case-review-workspace-v2.md](2026-08-05-mo-case-review-workspace-v2.md) | Разбор случая: UI + gold + протоколы МЗ (W0-W3 в проде r19; handoff 08-06) | active |
