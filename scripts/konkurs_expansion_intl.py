...
Три tier: **Tier 1 (CIS)** - клинические протоколы/КР на русском, минимальная стоимость входа после РБ. **Tier 2** - крупные рынки с STG/CPG/PCDT на EN/PT/TR/AR. **Tier 3 (2033+)** - Китай (临床路径, inpatient DRG), EU/NICE - отложены из-за языка, фрагментации корпуса или доминирования Epic/UpToDate.
""".strip()
