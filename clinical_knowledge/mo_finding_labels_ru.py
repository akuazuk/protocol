...
FINDING_TITLE_RU: dict[str, str] = {
    ...
    "B_lab_ordered_already_done": "Лаборатория: назначенное обследование уже есть на складе",
    "B_lab_present_not_in_mo": "Лаборатория: анализы есть, в МО не указаны",
    "B_dx_lab_context": "Диагноз можно сверять с лабораторией склада",
    "B_lab_unused_in_dx": "Готовый анализ не учтён в диагнозе",
    "B_lab_unused_in_plan": "Готовый анализ не учтён в плане",
    "B_lab_ordered_not_used": "Результат лаборатории не разобран в текущем МО",
    "B_lab_abnormal_ignored": "Отклонение анализа не отражено в заключении",
    ...
    "C_ppi_dup": "Дублирование ИПП",
    "C_antihistamine_dup": "Дублирование антигистаминных",
    "C_anticoag_dup": "Дублирование антикоагулянтов/антиагрегантов",
    "C_statin_dup": "Дублирование статинов",
    "C_ace_arb_dup": "Дублирование иАПФ/БРА",
    ...
    "C_formulary_unknown": "Препарат не найден в локальном seed формуляра",
    "C_drug_disease_mismatch": "Назначение слабо согласуется с диагнозом",
    "C_rceth_off_label": "Назначение вне показаний инструкции",
    "C_rceth_contraindication": "Противопоказание по инструкции ЛС",
    "C_rceth_age_outside_label": "Возраст вне инструкции ЛС",
...
_SOURCE_EXACT_RU: dict[str, str] = {
    ...
    "rceth_label_v1": (
        "Сверка назначения с официальной инструкцией ЛС (реестр rceth). "
        "Черновик: не меняет оценку диагноза и не ставит в очередь Критично."
    ),
    "mo_lab_shadow_v1": (
        "Сверка рекомендаций по обследованию с лабораторией склада (type_name). "
        "Черновик: не меняет итоговую оценку."
    ),
