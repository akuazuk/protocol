...
Дата: 2026-08-09  
Статус: active (волна 1 UI в работе)  
Связанные:
...
5. [x] Волна 0 recompute на GCE после deploy (08-01..08-06).
6. [x] Волна 1: кольца + динамика на Сегодня (ветка `cursor/mo-today-rings-ui-pc1`).
