...
| [2026-09-25-mo-kp-embed-passport-v1.md](2026-09-25-mo-kp-embed-passport-v1.md) | Подбор КП: паспорт Ilex первым, `gemini-embedding-2` вторым проходом; золотой набор; база пересмотрена после K1-K3 | active (волны 1-3) |
| [2026-09-21-mo-visual-and-kp-v1.md](2026-09-21-mo-visual-and-kp-v1.md) | Подбор КП в витрину, свёрнутое решение методиста, визуал Обзора (преемник хвостов R7/W7) | completed (прод c0c84ac1; хвост: recompute 01-17 сентября) |
