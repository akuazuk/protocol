...
Экран строится по последнему доступному дню месяца, а не по будущей календарной
границе. Он содержит:

- KPI, прогноз темпа и равные периоды сравнения;
- динамику четырёх индексов и объёма с масштабированием и аномалиями;
- heatmap «специальность × глава МКБ»;
- врачей с поправкой на состав случаев, 95% ДИ и порогом n;
- Парето замечаний, воронку и прогресс CRM;
- №55 только при наличии подтверждённой метрики.

Контракт возвращает сверку суммы дневных агрегатов с MTD. При любой ненулевой
дельте UI показывает предупреждение и не маскирует расхождение.
