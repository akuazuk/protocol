...
| Файл | Тема | Статус |
|------|------|--------|
| [2026-08-09-mo-score-ssot-llm-recompute-v3.md](2026-08-09-mo-score-ssot-llm-recompute-v3.md) | C0-C5 выполнены; C6 secure pack готов для 18 cases / 22 labels, human labels 0/22 | active |
