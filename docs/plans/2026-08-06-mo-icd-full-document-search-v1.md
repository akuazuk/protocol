...
Дата: 2026-08-06  
Статус: archived  
Преемник: `2026-08-08-mo-icd-diag-slots-only-v1.md` (владелец: не искать МКБ/Dx по всему МО -
только «Клинический диагноз» / «Диагноз МИС»).  
Источник требования (исторический): владелец (разбор gold-кейса `3650612` / экспертный review pack).  
