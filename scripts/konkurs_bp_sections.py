...
Финансовый вывод. TAM 2,5 млн КЗ/мес — весь рынок; в осторожном плане 2029 захват 8% B2B (200 тыс. КЗ/мес) + 0,23% B2C. Выручка ~2,32 млн BYN/год (B2B 1,8 + B2C 0,44 + API 0,075), EBITDA ~+1,67 млн/год (~139 тыс./мес). Базовый сценарий (10% TAM): EBITDA ~+2,26 млн/год; оптимистичный (12%): ~+2,95 млн/год.
