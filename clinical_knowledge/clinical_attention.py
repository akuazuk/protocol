...
def build_clinical_attention(
    *,
    ...
    if top:
        ...
        if conf >= 0.85:
            add(
                "Высокое соответствие top-1 - на карточке протокола нажмите «Матрица КЗ» или «Продолжить с этим протоколом», отметьте обязательные пункты и при необходимости сформируйте шаблон КЗ.",
                "info",
            )
        elif conf < 0.65:
            add(
