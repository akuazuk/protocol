...
| [2026-08-08-mo-prior-dx-usage-baseline-v1.md](2026-08-08-mo-prior-dx-usage-baseline-v1.md) | Prior Dx у врача/специальности → одно МО + context для name_only/concordance/judge | active |
