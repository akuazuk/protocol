...
B2C UX (пилот): три сценария без личного кабинета - QR после визита (4,99 BYN), ссылка от клиники white-label (2,99 BYN promo), тревожный визит (?topic=, upsell L2 9,99 BYN). Подробно - раздел 8.1 PDF-версии бизнес-плана.
""".strip(),
    "9.": """
