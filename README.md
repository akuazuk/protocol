...
- **Проверка КЗ (PDF)** - главный экран при открытии сайта; прямая ссылка: `#consult-review`. Сверка заключения с фрагментами протоколов; сводка для методслужбы и зоны риска (&lt; 70% по критерию).
