...
1. Не смешивать «есть в справочнике МКБ» и «клиника поддерживает диагноз» в один finding.
2. Пороги калибровать отдельно (справочник vs клиника), API similarity общий.
